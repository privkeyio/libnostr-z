...
pub const Kind = struct {
    ...
    pub const group_create: i32 = 9000;
    pub const group_metadata: i32 = 9002;
    ...
    pub const nwc_request: i32 = 21000;
    pub const client_authentication: i32 = 22242;
    pub const nwc_response: i32 = 23194;
    pub const nwc_notification: i32 = 23195;
    ...
    pub const wiki_article: i32 = 30819;
...
test "Kind.classify matches kindType for backwards compatibility" {
    ...
    try std.testing.expectEqual(kindType(Kind.nwc_request), Kind.classify(Kind.nwc_request));
...
test "Kind.isEphemeral identifies ephemeral kinds" {
    try std.testing.expect(Kind.isEphemeral(Kind.nwc_request));
